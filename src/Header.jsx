...
const Header = () => {
  return (
    <>
        <header className="body-font bg-primary-green text-light-green font-medium fixed top-0 left-0 right-0 z-10">
            <div className="mx-auto flex flex-wrap px-5 items-center justify-between py-3">
                <a className="">
                    <img src={logo} className='h-14 sm:h-10' alt="" />
                </a>
